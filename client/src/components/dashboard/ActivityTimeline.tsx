          ...
          <div className="space-y-6">
            {activities.map((activity) => (
              <div key={activity.id} className="relative pl-8">
                <div className="absolute left-0 rounded-full bg-white dark:bg-gray-900 border-2 border-primary w-3.5 h-3.5"></div>
                <div className="flex flex-col">
                  ...
                  {activity.blockchainVerified && (
                    <div className="flex items-center mt-2">
                      <span className="text-xs font-medium bg-green-100 dark:bg-green-900/20 text-green-800 dark:text-green-400 px-2 py-0.5 rounded">
